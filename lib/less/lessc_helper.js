...
var lessc_helper = {
    ...
    printUsage: function() {
        ...
        sys.puts("  -l, --link-file         Specify a file to load to link custom javascript.");
        sys.puts("                          The file should export a function named 'link',");
        sys.puts("                          which takes the global tree as a parameter.");
    ...
    linkFiles: function(tree, files) {
        files.forEach(function(f) { require(f).link(tree); });
    }
}
